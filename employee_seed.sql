...
VALUES ("John","Doe", 1), ("Mike", "Chan", 2), ("Ashley", "Rodriguez", 3), ("Kevin", "Tupik", 4), ("Malia", "Brown", 5), ("Sarah", "Lourd", 6), ("Tom", "Allen", 7), ("Christian", "Eckenrode", 3);
...
UPDATE employee SET manager_id = 3 WHERE id in (1, 4);
UPDATE employee SET manager_id = 2 WHERE id in (8);
